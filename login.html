...
.btn{
  ...
  <img src="1.png" width="30%" style="margin-top:2%" \>

	<br \><br \>
			<div class="container">
					<div style="color:white">
					<label>============================================</label><br \>
					<label>     Silahkan Login Menggunakan Email dan Password</label>
					<label>Jika Tidak Mempunyai Membuat Akun, Silahkan Klik Daftar</label>
					<label>============================================</label>
					</div>
                <form method="post">
