...
<head>
    ...
    <title>STM Valorant Indonesia: Pendaftaran</title>
    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                    <a href="index.php"><img src="../1.png" alt="logo" width="100%"></a>
            </div>
            <div class="main-menu">
                            ...
                            <div class="card-body">
                                ...
                                <div class="market-status-table mt-4">
                                    <div class="table-responsive">
                                         ...
                                         <br>Sistem ini disusun oleh Kelompok 6 Sistem Informasi
                                         <br><br>
                                         Panduan Pendaftaran:
...
<!------------------ Pisahin ------------------->
        ...
        <footer>
            <div class="footer-area">
                <p>PPDB Online by STM Valorant Indonesia</p>
            </div>
        </footer>
        <!-- footer area end-->
    </div>
