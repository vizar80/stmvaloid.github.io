...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="#page-top">STM Valorant Indonesia</a>
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-0">STM Valorant Indonesia</p>
            </div>
        </header>
        <!-- Portfolio Section-->
        ...
        <section class="page-section bg-primary text-white mb-0" id="panduan">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 ml-auto"><p class="lead">Pendaftaran Jurusan akan dibuka untuk tahun ajaran 2021-2022. Jurusan Map Bind, Teknik Komputer Map Split, Rekayasa Perangkat Lunak Ice Book.</p></div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <p class="lead mb-0">
                          JL. Raya Putat Lor, Gondanglegi, Dusun Baron, Putat Lor, Kec. Gondanglegi, Malang, Jawa Timur 65174
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="copyright py-4 text-center text-white">
            <div class="container"><small>PPDB Online By STM Valorant Indonesia</small></div>
        </div>
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    <h2 class="portfolio-modal-title text-secondary text-uppercase mb-0" id="portfolioModal1Label">JADWAL PENDAFTARAN</h2>
                                    <!-- Icon Divider-->
                                    <div class="divider-custom">
                                        <div class="divider-custom-line"></div>
                                        <div class="divider-custom-icon"><i class="fas fa-star"></i></div>
                                    ...
                                    <b class="mb-5",style=”text-align: center;”>Pendaftaran akan ada 3 Gelombang</b>
                                    <p class="mb-10"></p>
                                
                                <div class="mb-3", style=”text-align: left;”>Gelombang I Pendaftaran   : 27 Agustus 2021 - 30 Agustus 2021</div>
                                <div class="mb-3",style=”text-align: left;”>Gelombang II Pendaftaran  : 2 September 2021 - 30 September 2021</div>
                                <div class="mb-3",style=”text-align: left;”>Gelombang III Pendaftaran : 25 Otober 2021 - 30 Desember 2021</div>
